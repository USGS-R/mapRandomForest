...
#' Rutledge (1998).
#'
#' This function is adapted from the USGS smwrBase package originally written
#' by David L. Lorenz, who converted Al Rutledge's Fortran code to R.
#'
...
#'proposed without details in Rutledge (1998).
#' @keywords baseflow
#' @examples
#'
#'\dontrun{
...
#'ChopPart <- with(ChoptankFlow, bf_part(discharge, datetime, da=113,
#'STAID="01491000"))
#'ChopPart
#'}
#'@export
